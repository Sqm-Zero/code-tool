<template>
  <div class="home-container flex max-h-full relative max-md:flex-col">
    ...
    <!-- 左侧个人信息区 -->
    <div
      class="sidebar min-w-1/3 md:min-w-0 xl:basis-1/3 xl:h-screen xl:sticky xl:top-0 flex items-center flex-col relative">
        ...
        <div
          ...
          <div class="info-section">
            ...
            <div class="name-section">
              <h1 class="username">库库林-沙琪马</h1>
              <div class="user-badges">
                <span class="badge badge-pro">马太君</span>
            ...
            <div class="social-links">
              <a href="https://github.com/Sqm-Zero" target="_blank" class="social-link github-link">
              ...
              <a href="tencent://AddContact/?uin=1789714718" target="_blank" class="social-link twitter-link">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path
              ...
              <a href="mailto:1789714718@qq.com" class="social-link email-link">
    ...
    <!-- TODO 抽屉 -->
    <el-drawer v-model="showTodoDrawer" title="每日 TODO" :size="isMobile ? '90%' : '600px'" direction="rtl"
      :with-header="true">
  ...
  fetch(myYiYan)
    ...
    .then(({ hitokoto }) => {
      ...
      typerInstance = new EasyTyper(
        ...
        hitokoto,
        () => {
          setTimeout(fetchData, 2000); // 添加延迟，让用户有时间阅读
        },
        () => { }
      );
    })
